...
export async function sampleContrast(page,out,label){
   ...
   const glyph=(await page.screenshot({fullPage:true,scale:"css"})).toString('base64');
   ...
   const bg=(await page.screenshot({fullPage:true,scale:"css"})).toString('base64');await style.evaluate(e=>e.remove());
   ...
   const fg=(await page.screenshot({fullPage:true,scale:"css"})).toString('base64');await gradStyle.evaluate(e=>e.remove());
   ...
   await page.screenshot({path:out+'/'+label+'.png',scale:'css'});
   return measured;
}
